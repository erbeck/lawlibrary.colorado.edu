...
<div id="wrapper">
  <header id="header" class="clearfix">
    <?php if (theme_get_setting('image_logo','WiseLaw')): ?>
  ...
  <div id="main" class="clearfix">
    <div id="primary">
      <section id="content" role="main">
        ...
        <?php if ($is_front): ?>
        <?php if (theme_get_setting('slideshow_display','WiseLaw')): ?>
        <?php 
        $slide1_url = check_plain(theme_get_setting('slide1_url','WiseLaw'));
        $slide2_url = check_plain(theme_get_setting('slide2_url','WiseLaw'));
        $slide3_url = check_plain(theme_get_setting('slide3_url','WiseLaw'));
        $slide1_desc = check_markup(theme_get_setting('slide1_desc', 'WiseLaw'), 'full_html'); 
        $slide2_desc = check_markup(theme_get_setting('slide2_desc', 'WiseLaw'), 'full_html'); 
        $slide3_desc = check_markup(theme_get_setting('slide3_desc', 'WiseLaw'), 'full_html'); 
        ?>
        <div id="slider">
          <div id="slider-wrap">
            <div class="slides displayblock">
              <a href="<?php print url($slide1_url); ?>"><img width="664" height="330" src="<?php print base_path() . drupal_get_path('theme', 'WiseLaw') . '/images/slide-image-1.jpg'; ?>" class="pngfix"/></a>
              <?php if($slide1_desc) { print '<div class="featured-text">' . $slide1_desc . '</div>'; } ?><!-- .featured-text -->
            </div> <!-- .slides -->

            <div class="slides displaynone">
              <a href="<?php print url($slide2_url); ?>"><img width="664" height="330" src="<?php print base_path() . drupal_get_path('theme', 'WiseLaw') . '/images/slide-image-2.jpg'; ?>" class="pngfix"/></a>
              <?php if($slide1_desc) { print '<div class="featured-text">' . $slide2_desc . '</div>'; } ?><!-- .featured-text -->
            </div> <!-- .slides -->

            <div class="slides displaynone">
              <a href="<?php print url($slide3_url); ?>"><img width="664" height="330" src="<?php print base_path() . drupal_get_path('theme', 'WiseLaw') . '/images/slide-image-3.jpg'; ?>" class="pngfix"/></a>
              <?php if($slide1_desc) { print '<div class="featured-text">' . $slide3_desc . '</div>'; } ?><!-- .featured-text -->
            </div> <!-- .slides -->
          </div>
          <div id="nav-slider">
            <div class="nav-previous"><img class="pngfix" src="<?php print base_path() . drupal_get_path('theme', 'WiseLaw') . '/images/previous.png'; ?>" alt="next slide"></div>
            <div class="nav-next"><img class="pngfix" src="<?php print base_path() . drupal_get_path('theme', 'WiseLaw') . '/images/next.png'; ?>" alt="next slide"></div>
          </div>
        </div>
        <?php endif; ?>
        <?php endif; ?>
  ...
  <footer id="footer-bottom">
    ...
    <div id="bottom" class="clearfix">
	  <div id="site-footer">
		<div id="inner-flex">
		  <div class="libdress">
		  <a href="http://lawlibrary.colorado.edu/">William A. Wise Law Library</a><br />
		  University of Colorado Law School<br />
		  Wolf Law Building, 2nd Floor<br />
		  2450 Kittredge Loop Drive<br />
		  Boulder, CO 80309-0402<br />
		  303.492.7534<br />
		  <a href="http://lawlibrary.colorado.edu/about/contact-us">Contact Us</a>
		  </div>
		  
		  <?php if (theme_get_setting('socialicon_display', 'WiseLaw')): ?>
			<?php 
			$twitter_url = check_plain(theme_get_setting('twitter_url', 'WiseLaw')); 
			$facebook_url = check_plain(theme_get_setting('facebook_url', 'WiseLaw')); 
			$google_plus_url = check_plain(theme_get_setting('google_plus_url', 'WiseLaw')); 
			$pinterest_url = check_plain(theme_get_setting('pinterest_url', 'WiseLaw'));
			?>
      ...
      <div id="cu-bottom">
		<p>
		<img src="https://www.colorado.edu/law/profiles/express/themes/expressbase/images/beboulder/be-boulder-white.png">
		</p>
